...
-export([coin/0,get_random_string/2,mine_coin/0,loop/1,check_if_coin/2]).
%-compile(export_all).
...
loop(Count) ->
    ...
    UFname = "mbudhwani",
    InputK = 1,
    Pid = spawn('mohit2@Mohits-MacBook-Air.local',fun() -> mine_coin() end),
